...
rounds = 8000; % Number of rounds per simulation
k = 1000; % Bits transmitted per packet
...
max_dist = 1; % Maximum mobility for sensor nodes (in m)
sn_min_dist = 1; % Minimum mobility for sink nodes (in m)
sn_max_dist = 50; %Maximum mobility for sink nodes (in m)
